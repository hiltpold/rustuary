...
- Workbench playground now keeps data setup compact, exposes portfolio and segment filters beside the claims triangle, and keeps full triangle paths as a secondary quick-pick.
